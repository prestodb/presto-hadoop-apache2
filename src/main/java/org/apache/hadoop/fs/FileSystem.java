        ...
        PathCapabilities, BulkDeleteSource
{
    ...
    public ContentSummary getContentSummary(Path f) throws IOException
    {
        ...
        for (FileStatus s : listStatus(f)) {
            ...
            ContentSummary c = s.isDirectory() ? getContentSummary(s.getPath()) :
                    new ContentSummary.Builder().length(length).fileCount(1).directoryCount(0).spaceConsumed(length).build();
     ...
     */
    protected class DirListingIterator<T
            extends FileStatus>
    ...
    public static final class Statistics
    {
         ...
         */
        private final class StatisticsDataReference
        ...
        public long getBytesReadErasureCoded()
        {
            return visitAll(new StatisticsAggregator<Long>()
            {
                private long bytesReadErasureCoded;
